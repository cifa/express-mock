(function() {
  ...
  exports.findExitingIds = function(query) {
    var parent, idName;
    parent = findParent(getSegments(query.path), query.paramNames, query.paramValues);
    idName = query.paramNames[query.paramNames.length - 1];
